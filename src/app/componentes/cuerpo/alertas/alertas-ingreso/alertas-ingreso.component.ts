...
@Component({
  selector: 'app-alertas-ingreso',
  templateUrl: './alertas-ingreso.component.html',
  styleUrls: ['./alertas-ingreso.component.css']
})
export class AlertasIngresoComponent {
  ...
  guardar_evento(form: NgForm) {
    ...
    if (!this.validacion) {
      ...
      this.api_serve.alertas(this.formData).subscribe({
